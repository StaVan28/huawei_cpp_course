...
namespace
{
const int CHAR_MEMORY  = 25;
const int CAPACITY_MIN = 4;
const int CAPACITY_DIF = 4;
const int TWO_CANARIES = 2;
const int HAVE_ERROR   = 0;

const int    POISON_INT_STACK    = 0X1CD7E30B;
const double POISON_DOUBLE_STACK = NAN;

const int CANARY_LEFT_STACK  = 0X237CA57A;
const int CANARY_RIGHT_STACK = 0X2CD71868;
const int CANARY_LEFT_DATA   = 0X3425D763;
const int CANARY_RIGHT_DATA  = 0X37B6B0FE;
